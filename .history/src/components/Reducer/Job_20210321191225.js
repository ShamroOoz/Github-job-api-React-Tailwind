    ...
    <div className="flex shadow-lg ring-2 ring-blue-500 mx-8 my-3 rounded">
      <div className="w-full flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          <div className=" overflow-ellipsis border rounded-lg p-4 bg-gray-200">
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          <div className="border rounded-lg p-4 bg-gray-200">
            ...
            <button class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-blue-700 underline uppercase transition bg-transparent rounded ripple hover:text-blue-900 focus:outline-none">
              Link
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-200 px-6 py-3 flex justify-between">
          <div>
            ...
            <div className="flex items-center  mt-2">
              ...
              <div className="ml-4">
                <h2 className=" text-sm font-bold">Quote Velocity</h2>
                <a
