...
const Job = ({ result, toggle }) => {
  ...
  return (
    <div
      className={`flex shadow-lg mx-8 my-3 rounded ${
        toggle === 1 ? " " : "ring-2 ring-blue-500"
      }`}
    >
      <div className="w-full flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
        <div className={`bg-gray-200 text-black text-lg px-6 py-4 font-bold`}>
          {title}
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          <div
            className={` ${
              Seemore ? "truncate" : ""
            }  border rounded-lg p-4 bg-gray-200`}
          >
